...
describe('GET', function () {
    ...
    it.skip('respond 200 of image is exists and generated resize image', function (done) {
    ...
    it('respond 200 of image is exists and generated rotate image', function (done) {

        request(server)
            .get('/imgs/hank-hill.png?rotate=60')
            .expect(200)
            .expect('Image-Name', 'hank-hill_k_90')
            .end((err, res) => {
                setTimeout(function () {
                    if (err) return done(err)
                    done()
